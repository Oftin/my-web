  ...
  return (
    <>
      ...
      <FlexColumn
        items={"center"}
        justify={"center"}
        styles={`margin-top: 3rem; padding: 5em 0; height: 100%; background-color: ${colors.background.ebonyClay}`}
      >
        <Text
        ...
        />
        <FlexColumn items={"center"} justify={"center"} styles="width: 80vw;">
          <FlexColumn items={"start"} justify={"center"} styles="width: 100%;">
            <Text
              text={"Abstract"}
              color={colors.greenThemeColor}
              size={"24px"}
